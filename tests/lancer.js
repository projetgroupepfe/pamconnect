...
const SERIES = [
  ...
  "test_photos", "test_telephone", "test_publication", "test_mise_en_relation",
  "test_annuaire", "test_profil_en_avant", "test_mot_de_passe_oublie", "test_tarif_equipe", "test_liberer_demande", "test_demande_proposee",
];
