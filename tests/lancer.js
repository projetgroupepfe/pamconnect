...
const SERIES = [
  ...
  "test_versements", "test_jetons", "test_bienvenue", "test_repondre_jeton", "test_mise_en_avant", "test_avis", "test_classement", "test_api", "test_api_employeur", "test_demonstration",
];
